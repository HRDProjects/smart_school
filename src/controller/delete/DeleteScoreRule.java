 ...
 */
@WebServlet("/admin/deleteScoreRule.hrd")
public class DeleteScoreRule extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteScoreRule() {
        super();
	...
	public void doProcess (HttpServletRequest request, HttpServletResponse response) throws IOException {
		try{
	    int id=Integer.parseInt(request.getParameter("rule_id"));
	    if(new model.delete.deleteScore().deleteScoreRule(id)){
