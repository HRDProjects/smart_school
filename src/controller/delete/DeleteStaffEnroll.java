 ...
 */
@WebServlet("/admin/deleteStaffEnroll.hrd")
public class DeleteStaffEnroll extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeleteStaffEnroll() {
		super();
	...
	public void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		int id = Integer.parseInt(request.getParameter("class_enroll"));
		System.out.println("C"+id);
		if (new model.delete.DeleteEnroll().deleteClassEnroll(id)) {
