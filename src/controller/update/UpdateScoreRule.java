 ...
 */
@WebServlet("/admin/updateScoreRule.hrd")
public class UpdateScoreRule extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateScoreRule() {
		super();
	}
	...
	public void doProcess(HttpServletRequest request, HttpServletResponse response) throws IOException {
		try {
			...
			dto.setRule_id(Integer.parseInt(request.getParameter("rule_id")));
			...
			if (new model.update.UpdateScore().updateScoreRule(dto)) {
