 ...
 */
@WebServlet("/admin/listSummary.hrd")
public class ListSummary extends HttpServlet {
	...
	public void doProcess (HttpServletRequest request, HttpServletResponse response) throws  Exception{
		...
		try {
		    model.select.SelectSummary lst=new model.select.SelectSummary();
		    String sub=Convertor.convertResultSetIntoJSON(lst.selectSummary()).toString();
		    lst.close();
