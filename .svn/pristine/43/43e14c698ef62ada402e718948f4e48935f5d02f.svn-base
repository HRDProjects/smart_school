 ...
 */
@WebServlet("/admin/deleteStaff.hrd")
public class DeleteStaff extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)  {
	 ...
	 /**
	   * Create method doProcess type boolean for delete record staff.
	   * Create variable id type of Integer throw into ModelDelete _
	   * for excuteQuery Delete Record staff from db.  
	...
	try{	 int id=Integer.parseInt(request.getParameter("stff_id"));
	 if(new model.delete.DeleteStaff().deleteProcess(id)){
